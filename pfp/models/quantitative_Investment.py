...
class Target(models.Model):
    ...
    is_active = models.BooleanField('激活', null=False, blank=False, default=True)
...
class TargetTransaction(models.Model):
    target = models.ForeignKey(to=Target, on_delete=models.CASCADE, verbose_name='标第',
    ...
    change_percentage = models.DecimalField('换手率', max_digits=7, decimal_places=4, blank=False, default=0)
    transaction_num = models.DecimalField('成交量', max_digits=25, decimal_places=1, null=False, blank=False, default=0)
    transaction_money = models.DecimalField('成交金额', max_digits=25, decimal_places=1, null=False, blank=False, default=0)
    target_price = models.DecimalField('市值', max_digits=25, decimal_places=1, null=False, blank=False, default=0)
    change_price = models.DecimalField('流通市值', max_digits=25, decimal_places=1, null=False, blank=False, default=0)
    is_active = models.BooleanField('激活', null=False, blank=False, default=True)
